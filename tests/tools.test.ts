...
describe('QuickBooks Tools', () => {
  ...
  describe('Minimal Tools', () => {
    ...
    it('should register health_check tool', () => {
      ...
      expect(healthTool.description).toContain('Check if the QuickBooks MCP server is running');
    });
    ...
    it('should register authenticate tool', () => {
      ...
      expect(authTool.description).toContain('Start QuickBooks OAuth authentication flow');
    });
    ...
    it('should register clear_auth tool', () => {
      ...
      expect(clearAuthTool.description).toContain('Clear stored QuickBooks authentication');
    });
    ...
    it('authenticate should start OAuth flow', async () => {
      ...
      expect(result.content[0].text).toContain('QuickBooks Authentication');
    ...
    it('clear_auth should disconnect and clear tokens', async () => {
      ...
      expect(result.content[0].text).toContain('QuickBooks authentication tokens have been cleared');
    });
